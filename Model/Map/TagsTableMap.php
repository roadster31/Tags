...
class TagsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Tags.Model.Map.TagsTableMap';
     ...
     */
    const OM_CLASS = '\\Tags\\Model\\Tags';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Tags.Model.Tags';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tags\\Model\\Tags');
        $this->setPackage('Tags.Model');
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TagsTableMap::ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tags\Model\Tags) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(TagsTableMap::DATABASE_NAME);
            $criteria->add(TagsTableMap::ID, (array) $values, Criteria::IN);
        }

        $query = TagsQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { TagsTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { TagsTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TagsTableMap::ID) && $criteria->keyContainsValue(TagsTableMap::ID) ) {
