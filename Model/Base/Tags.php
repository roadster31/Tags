...
abstract class Tags implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tags\\Model\\Map\\TagsTableMap';
    ...
    /**
     * Initializes internal state of Tags\Model\Base\Tags object.
     */
     ...
     *
     * @return Tags The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TagsTableMap::ID] = true;
        }
    ...
    public function setTag($v)
    {
        ...
        if ($this->tag !== $v) {
            $this->tag = $v;
            $this->modifiedColumns[TagsTableMap::TAG] = true;
        }
    ...
    public function setSource($v)
    {
        ...
        if ($this->source !== $v) {
            $this->source = $v;
            $this->modifiedColumns[TagsTableMap::SOURCE] = true;
        }
    ...
    public function setSourceId($v)
    {
        ...
        if ($this->source_id !== $v) {
            $this->source_id = $v;
            $this->modifiedColumns[TagsTableMap::SOURCE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TagsTableMap::translateFieldName('Source', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TagsTableMap::ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TagsTableMap::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TagsTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(TagsTableMap::TAG)) {
            $modifiedColumns[':p' . $index++]  = 'TAG';
        }
        if ($this->isColumnModified(TagsTableMap::SOURCE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagsTableMap::ID)) $criteria->add(TagsTableMap::ID, $this->id);
    ...
    {
        $criteria = new Criteria(TagsTableMap::DATABASE_NAME);
        $criteria->add(TagsTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tags\Model\Tags (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Tags\Model\Tags Clone of current object.
     * @throws PropelException
     */
